  ...
  class CaptchaComponent extends Component{
    ...
    public $themes = array(
      'default'=>array(
        ...
        'txtcolor'=>array(15, 30, 80),
        'noisecolor'=>array(200, 200, 200)
      )
    );
    public $settings = array(
      'font' => 'fonts/admin/monofont.ttf', //arial.ttf - place font file somewhere and specify path here.
      'width' => 120,
      'height' => 40,
      'characters' => 6,
      'theme'=>'default',
    ...
    function generateCode($characters) {
      ...
      $possible = '1234567890abcdefghijklmnopqrstuvwxyzABCDFGHJKMNPRSTVWXYZ1234567890';//ABCDFGHJKMNPRSTVWXYZ
      $code = '';
      $i = 0;
      while ($i < $characters) { 
