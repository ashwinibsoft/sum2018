...
<?php echo $this->Form->create('Supplier',array('name'=>'suppliers','id'=>'SupplierCms','action'=>'add',$supplier_id,'onsubmit'=>'//return validatefields();','type'=>'file'))?>
 <?=$this->Form->hidden('action', array('id' => 'action', 'value' => '')); ?>
<?php echo $this->Form->input('id');?>
<?php  echo $this->Form->hidden('parent_id'); ?>
<?php  echo $this->Form->hidden('form',array('value'=>'supplier_add')); ?>
<?php  echo $this->Form->hidden('status',array('value'=>1)); ?>
<?php  echo $this->Form->hidden('url_back_redirect',array('value'=>$referer_url)); ?>
	<div class="row">
		<div class="col-md-12">
			<?php echo $this->element('admin/admin_basic',array(),array('plugin'=>'SupplierManager')); ?>
		</div>
...
<?php echo $this->element('admin/forms/form_validation_js',array('form_id'=>'SupplierCms','form_validation_url'=>Router::url(array('plugin'=>'supplier_manager','controller'=>'suppliers','action'=>'ajax_validation','json','admin'=>false)))); ?>
