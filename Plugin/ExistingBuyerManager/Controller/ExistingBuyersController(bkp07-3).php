...
Class ExistingBuyersController extends ExistingBuyerManagerAppController{
	...
	private function __check_eb($id=null) {	
	  ...
	  public function add_existing_buyer($nb_button=null) {
	...
	public function replace_exist_ajax($id=null) {  
		...
		echo $exist_id = $this->ExistingBuyer->find('count', array('conditions' => array('ExistingBuyer.status'=>1,'ExistingBuyer.replace'=>1,'ExistingBuyer.supplier_id'=>$member_id)));
