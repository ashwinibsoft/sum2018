<div class="grid simple horizontal green no-margin-grid">
	...
	<div class="grid-body no-border">
		...
		<div class="form-group">
            ...
            <span style="color:red;">*</span>
			<span style="" class="tip" data-toggle="tooltip" title="This field is used for job title." data-placement="right"><i class="fa fa-question-circle"></i></span>
			<div class="controls">
				<?=$this->Form->text('job_title',array('class'=> 'form-control','size'=>'45','required'=>false)); ?>
				<?=$this->Form->error('job_title',null,array('wrap' => 'span', 'class' => 'error')); ?>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="form-label">Relationship To Supplier</label>
            <span style="color:red;">*</span>
			<span style="" class="tip" data-toggle="tooltip" title="This field is used for relationship to supplier." data-placement="right"><i class="fa fa-question-circle"></i></span>
			<div class="controls">
				<?//=$this->Form->text('relationship',array('class'=> 'form-control','size'=>'45','required'=>false)); ?>
				<?php echo $this->Form->input('relationship',array('options'=>array('esupplier'=>'Existing supplier','psupplier'=>'Past supplier'),'label' => false,'div'=>false,'empty'=>'Relationship to Supplier','class'=>'simple-dropdown colorGrey noValue')); ?>
				<?=$this->Form->error('relationship',null,array('wrap' => 'span', 'class' => 'error')); ?>
			</div>
		</div>
